...
const DatosGenerales = () => {
  ...
  return (
   <div className='bg-white text-black p-20 flex flex-col gap-5 justify-between items-start space-y-6'>
      <div className='flex flex-col sm:gap-3 lg:gap-5'>
       <h1 className='text-blue-600 font-bold mb-4 sm:text-sm md:text-md lg:text-2xl'>Datos Generales</h1>
